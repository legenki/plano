...
export const secuenciaSketch = (_p5) => {
  _p5.env = {
    ...
    set updateInterface_glyphSet_boxes(v) { updateInterface_glyphSet_boxes = v; },
    ...
    get activeGlyph() { return typeof activeGlyph !== 'undefined' ? activeGlyph : undefined; },
    set activeGlyph(v) { activeGlyph = v; },
    ...
    set updateInterface_glyphEditorContext_state(v) { updateInterface_glyphEditorContext_state = v; },
    ...
    set updateInterface_glyphEditorTools_state(v) { updateInterface_glyphEditorTools_state = v; },
    ...
    set updateInterface_textBoxSettings_state(v) { updateInterface_textBoxSettings_state = v; },
    ...
    set updateInterface_textBoxSettings_label(v) { updateInterface_textBoxSettings_label = v; },
    ...
    get random_wordSpace() { return typeof random_wordSpace !== 'undefined' ? random_wordSpace : undefined; },
    set random_wordSpace(v) { random_wordSpace = v; },
    get random_letterSpace() { return typeof random_letterSpace !== 'undefined' ? random_letterSpace : undefined; },
    set random_letterSpace(v) { random_letterSpace = v; },
    get random_letterWidth() { return typeof random_letterWidth !== 'undefined' ? random_letterWidth : undefined; },
    set random_letterWidth(v) { random_letterWidth = v; },
    get random_letterHeight() { return typeof random_letterHeight !== 'undefined' ? random_letterHeight : undefined; },
    set random_letterHeight(v) { random_letterHeight = v; },
    get random_slant() { return typeof random_slant !== 'undefined' ? random_slant : undefined; },
    set random_slant(v) { random_slant = v; },
    get random_randomSize() { return typeof random_randomSize !== 'undefined' ? random_randomSize : undefined; },
    set random_randomSize(v) { random_randomSize = v; },
    get random_randomLetterSpace() { return typeof random_randomLetterSpace !== 'undefined' ? random_randomLetterSpace : undefined; },
    set random_randomLetterSpace(v) { random_randomLetterSpace = v; },
    get random_randomLetterWidth() { return typeof random_randomLetterWidth !== 'undefined' ? random_randomLetterWidth : undefined; },
    set random_randomLetterWidth(v) { random_randomLetterWidth = v; },
    get random_randomLetterHeight() { return typeof random_randomLetterHeight !== 'undefined' ? random_randomLetterHeight : undefined; },
    set random_randomLetterHeight(v) { random_randomLetterHeight = v; },
    get random_randomSlant() { return typeof random_randomSlant !== 'undefined' ? random_randomSlant : undefined; },
    set random_randomSlant(v) { random_randomSlant = v; },
    get random_randomBaselineOffset() { return typeof random_randomBaselineOffset !== 'undefined' ? random_randomBaselineOffset : undefined; },
    set random_randomBaselineOffset(v) { random_randomBaselineOffset = v; },
    get random_precision() { return typeof random_precision !== 'undefined' ? random_precision : undefined; },
    set random_precision(v) { random_precision = v; },
